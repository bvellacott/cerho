...
export const getSubscriptions = async (store, action) => {
  await authenticate()
  const response = await fetch('https://sheets.googleapis.com/v4/spreadsheets/1qea5ecpnkVWNRM1nfAV9Zp7qElTrkTid4LAmt1ZntbI/', {
    headers: {
...
export default [
  [TYPES.GET_SUBSCRIPTIONS, getSubscriptions],
]
